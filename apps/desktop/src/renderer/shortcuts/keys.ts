...
export const KEYS = {
  ...
  // 전역
  createNote: ['n', 'ㅜ'],
  // 검색은 ⌘O 하나다 (BRU-213). 잠깐 ⌘K와 나눠 썼는데, 글을 쓰는 자리에서 ⌘K는
  // 어느 앱에서나 「링크 걸기」다(Word · Docs · Notion · Slack 입력창) — 편집기에
  // 돌려줬다. O는 "열기"의 관습이라 노트를 여는 이 자리에 더 정확하기도 하다.
  search: ['o', 'ㅐ'],
